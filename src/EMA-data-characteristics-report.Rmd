...
This section characterizes the proportion of submitted surveys that meet all item-completeness criteria specific to this project (non-missing mood, smoke, before_survey, and at least one branch variable). These are the observations available for dissertation analyses.
