...
# Create 'obsno' variable, representing the serial order of observations within-participant, and 'dayno' variable, representing the days since first completed beep. This is to prepare for biochemical abstinence verification data merging.
