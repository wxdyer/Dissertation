...
# Reorder variables
data = study_sample_full %>% arrange(participant_id, completion_time)
...
```{r}
obsno_max = 18
study_sample_full$compliance = ave(study_sample_full$valid, study_sample_full$participant_id, FUN=function(x) sum(x, na.rm=TRUE)) / obsno_max
