...
Overview when the beeps were sent in a calendar format
...
# Person-level mean and person-mean-centered versions of variables that will be used in analyses.`r txt('esm-mod','Modification',"the 'pos_aff' and 'neg_aff' variables are person-mean centered.")` 
```{r}
