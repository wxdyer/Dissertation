...
mutate(
  init_time       = with_tz(init_time, tzone = "UTC"),
    completion_time = with_tz(completion_time, tzone = "UTC")
  )
...
```
### 2.11.26 copied above into master pre-processing report in a different .Rmd. I left it here for a paper trail
